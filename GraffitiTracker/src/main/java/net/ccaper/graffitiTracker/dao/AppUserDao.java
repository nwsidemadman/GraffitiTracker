 ...
 * 
 * @author ccaper
 * Data Access Object for the {@link net.ccaper.graffitiTracker.objects.AppUser}
 */
public interface AppUserDao {
   ...
   *
   * @param appUser the {@link net.ccaper.graffitiTracker.objects.AppUser}
   */
  ...
  /**
   * Delete {@link net.ccaper.graffitiTracker.objects.AppUser}s when registration expired.
   */
   ...
   *
   * @param numberOfDays the number of days for count
   ...
   *
   * @param userid the userid
   * @param passwordEncoded the password encoded
   */
   ...
   *
   * @param id the id
   * @param roleAdditions the {@link net.ccaper.graffitiTracker.objects.Role} additions
   */
   ...
   *
   * @param id the id
   * @param roleDeletions the {@link net.ccaper.graffitiTracker.objects.Role} deletions
   */
